## Extract gridMET data for all MTBS fire centroids
library(tidyverse)
library(terra)
library(tidyterra)
library(climateR)
...
gridmet_vars <- c(
  "pr", "tmmn", "tmmx", "rmax", "rmin",
  "vpd", "bi", "erc", "fm100", "fm1000" #  , "pdsi" ## PDSI in different format and needs to be processed separately
)
...
write_parquet(final_dataset, "data/gridmet_long_data.parquet")
...
final_data <- open_dataset("data/gridmet_long_data.parquet")
