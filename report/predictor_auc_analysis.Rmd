...
## 5.3.1 Best Predictor Frequency (Presentation Version)

A larger-font version of the above plot suitable for slideshows.

```{r best-predictor-freq-presentation, fig.height=8, fig.width=12}
best_predictors %>%
  count(name, cover) %>%
  ggplot(aes(x = reorder(name, n), y = n, fill = cover)) +
  geom_col(position = "dodge", alpha = 0.8, width = 0.7) +
  scale_fill_manual(
    values = c("forest" = "#228B22", "non_forest" = "#DAA520"),
